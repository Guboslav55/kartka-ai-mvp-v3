      ...
      if (displayStyle === 'catalog' && !REPLICATE) {
        ...
        for (let i = 0; i < usableUrls.length; i++) {
          try {
            ...
            const url = await runFlux(usableUrls[i], prompt.slice(0, 1700), REPLICATE, aspect)
