  ...
  try {
    ...
    // ── PHOTO MODE ────────────────────────────────────────────────────────────
      ...
      const STYLES: Record<string, string> = {
        ...
        store:    'This EXACT product presented on a clean modern retail display stand or shelf in a stylish boutique. Product remains 100% identical, shown from the SAME side as the reference; do not rotate or flip it. Tasteful staging, soft retail lighting, shallow depth of field.',
        flatlay:  'Completely RESTAGE this EXACT product as a strict top-down FLAT-LAY: remove the hanger, remove the original background, wall, poster or painting entirely, and lay the garment FLAT on a clean styled surface (neutral fabric, wood or stone). Photograph it straight from directly above at a true 90-degree overhead angle, the garment spread out flat, fully visible, neatly arranged, zipped and symmetric. Show the SAME side of the garment as in the reference — if the reference shows the BACK, lay the BACK flat and keep it as a back view; never flip a back view into a front. Keep the EXACT same design and the same side as the reference — do not add or remove any detail. Do NOT show it hanging or on a hanger and do NOT keep the original backdrop. The product itself stays 100% identical in colour, fabric, logos and details. Even soft daylight, subtle realistic shadows.',
        catalog:  'This EXACT product alone, perfectly centred on a seamless studio background with a soft gradient and a subtle ground shadow, clean even e-commerce lighting. Product remains 100% identical, shown from the SAME side as the reference (a back view stays a back view); do not rotate or flip it.',
