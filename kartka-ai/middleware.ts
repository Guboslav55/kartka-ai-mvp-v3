...
const PROTECTED = ['/dashboard', '/generate', '/studio', '/stars', '/referral', '/profile', '/gallery', '/admin', '/onboarding', '/projects', '/card', '/tryon', '/video', '/generate-model', '/editor', '/upscale', '/templates', '/seo']
